...
export const Filters = () => {
    ...
    return (
        <>
            <div className={styles.filterCard} onClick={() => dispatch(toggleFilters())}>Фильтры {state.opened ? <span>&#9661;</span> : <span>&#9655;</span>}</div>
            {state.opened && 
            (<>
                ...
                <ServicesMenu isBanks={isBanks(state)} menuItems={choosedServices} />
            </>)}
        </>
    )
}
